            ...
            <div className="max-h-80 overflow-y-auto space-y-2">
              {leaderboard.map((entry) => (
                ...
                >
                  ...
                  <div className="col-span-5 flex items-center gap-2 min-w-0">
                    ...
                    <span
                      className={`truncate ${entry.isCurrentUser ? 'text-amber-400 font-medium' : 'text-white'}`}
                    >
                      {entry.displayName}
              ...
              {currentUserEntry && !leaderboard.some((e) => e.isCurrentUser) && (
                <>
                  ...
                  <div className="grid grid-cols-12 gap-2 px-3 py-3 rounded-lg bg-amber-500/20 border border-amber-500/50">
                    <div className="col-span-2 flex items-center">
                    ...
                    <div className="col-span-3 text-right flex items-center justify-end">
                      <span className="text-amber-400 font-bold">{currentUserEntry.score}</span>
                      <span className="text-slate-500 text-sm ml-1">/100</span>
                    </div>
                    <div className="col-span-2 text-right text-slate-300 flex items-center justify-end font-mono text-sm">
